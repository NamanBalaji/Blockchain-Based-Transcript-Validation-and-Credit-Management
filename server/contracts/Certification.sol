...
contract Certification {
    ...
    function generateCertificate(
        ...
        certificates[byte_id] = Certificate(_candidate_name, _org_name, _course_name, _expiration_date, _email);
    ...
    function getData(string memory _id) public view returns(string memory, string memory, string memory, uint256, string memory) {
        ...
        return (temp.candidate_name, temp.org_name, temp.course_name, temp.expiration_date, temp.email);
    }
}
